...
from src.schemas.sellers import BaseSeller, IncomingSeller, ReturnedSeller, ReturnedSellerWithoutPass, ReturnedAllSellersWithoutPass, ReturnedSellerBooks
...
@sellers_router.get("/", response_model=ReturnedAllSellersWithoutPass, status_code=status.HTTP_200_OK)
